  ...
  return (
    <section className="relative before:pointer-events-none before:absolute before:inset-0 before:-z-10 before:h-[120%] before:bg-linear-to-b before:from-gray-100">
      <div
        ...
        aria-hidden="true"
      >
        <div className="h-80 w-80 rounded-full bg-linear-to-tr from-gray-500 to-gray-900 opacity-30 blur-[160px] will-change-[filter]"></div>
      </div>
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          {/* Testimonials grid */}
          <div className="grid gap-4 [mask-image:linear-gradient(to_top,--theme(--color-white/.3),black_800px)] sm:grid-cols-3 md:gap-6">
