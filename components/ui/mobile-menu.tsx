            ...
            {!userLoggedIn ? (
              <>
                ...
                <li>
                  <Link
                    href="/signup"
                    className="flex rounded-lg px-2 py-1.5 font-medium text-blue-600 hover:bg-gray-100"
                    onClick={() => setMobileNavOpen(false)}
                  >
                    Register
                  </Link>
              ...
              <li>
                <button
                  ...
                  className="flex w-full rounded-lg px-2 py-1.5 text-left text-gray-700 hover:bg-gray-100"
                >
                  Sign Out
                </button>
              </li>
